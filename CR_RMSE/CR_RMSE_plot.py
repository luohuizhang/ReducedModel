...
plt.savefig(name_hat+'CR_RMSE_ZFP_S3D.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_XGC.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_NYX.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
ax.set_xlim([min(data[37,:])/2,10**-2])
#ax.legend(loc="upper left",ncol=1, fontsize=28)
#ax.set_xlabel("(a) Heat3d",{'family' : 'Times New Roman', 'size'   : 36})
#plt.tight_layout()

plt.savefig(name_hat+'CR_RMSE_ZFP_CESM-ATM.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_Hurricane.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_Astro.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
ax.set_xscale('log')
ax.set_ylim([0,100]);
ax.set_xlim([min(data[19,:])/2,max(data[19,:])*2])
#ax.legend(loc="upper left",ncol=1, fontsize=28)
#ax.set_xlabel("(a) Heat3d",{'family' : 'Times New Roman', 'size'   : 36})
#plt.tight_layout()

plt.savefig(name_hat+'CR_RMSE_ZFP_Sedov.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_Wave.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_Laplace.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
...
plt.savefig(name_hat+'CR_RMSE_ZFP_Heat3d.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
