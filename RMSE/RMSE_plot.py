...
plt.savefig(name_hat+'RMSE_ZFP.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()


data = np.loadtxt("SZ.result.dat")
data=data.reshape(-1,4)
x=range(0,10)
CR=data[0:40,3]
CR=CR.reshape(10,4)
...
plt.savefig(name_hat+'RMSE_SZ.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
#plt.show()
